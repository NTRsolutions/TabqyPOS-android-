...
import com.pos.user.tabqy.activities.test.CustomListAdapter;
import com.pos.user.tabqy.activities.test.CustomListResponse;
import com.google.gson.Gson;

public class TestActivity extends AppCompatActivity implements CustomListAdapter.Listener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerPendingList = findViewById(R.id.recyclerPendingList);
